...
const publicBaseUrl = (process.env.HOZO_PUBLIC_BASE_URL || 'https://hozo-am-line-oa-webhook.onrender.com').replace(/\/+$/, '');
...
if (!controlApiKey && !dryRun) fail('HOZO_CONTROL_API_KEY is not set.');
