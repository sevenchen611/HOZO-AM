...
if (existing) {
  console.log(JSON.stringify({
    ...
    url: existing.url,
    renderEnvVar: `HOZO_DAILY_REPORT_SNAPSHOTS_DATA_SOURCE_ID=${existing.id}`,
  }, null, 2));
  process.exit(0);
}
...
console.log(JSON.stringify({
  ...
  dataSourceId,
  url: database.url,
  renderEnvVar: dataSourceId ? `HOZO_DAILY_REPORT_SNAPSHOTS_DATA_SOURCE_ID=${dataSourceId}` : null,
}, null, 2));
