...
const responsibilityDataSourceId = process.env.HOZO_RESPONSIBILITY_DATA_SOURCE_ID || '';
...
if (!responsibilityDataSourceId) fail('HOZO_RESPONSIBILITY_DATA_SOURCE_ID is not set.');
